...
big_category = consumables


class Consumeable(BaseItem):
    def __init__(self) -> None:
        super().__init__(big_category, consumables)
        self.time_cast=''
...
def process(small_category):
    ...
    for div in div_item:
        ...
        a.time_cast = div.find('div', 'media-body').contents[2].text
